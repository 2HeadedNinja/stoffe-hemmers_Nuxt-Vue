<?php
  ...
  $return->navigation[] = (object) array(
    ...
    'sub'   => array(
      (object) array(
        'label' => 'Babywelt',
        'url'   => '/category/inspiration/babywelt.html'
      ),
      (object) array(
        'label' => 'Cosplay',
        'url'   => '/category/inspiration/cosplay.html'
      ),
      (object) array(
        'label' => 'Fußball',
        'url'   => '/category/inspiration/fussball.html'
      ),
      (object) array(
        'label' => 'Gartenwelt',
        'url'   => '/category/inspiration/gartenwelt.html'
      ),
      (object) array(
        'label' => 'Halloween',
        'url'   => '/category/inspiration/halloween.html'
      ),
      (object) array(
        'label' => 'Karneval & Fasching',
        'url'   => '/category/inspiration/karneval-und-fasching.html'
      ),
      (object) array(
        'label' => 'Kinderwelt',
        'url'   => '/category/inspiration/kinderwelt.html'
      ),
      (object) array(
        'label' => 'Maritime Welt',
        'url'   => '/category/inspiration/maritime-welt.html'
      ),
      (object) array(
        'label' => 'Oktoberfest',
        'url'   => '/category/inspiration/oktoberfest.html'
      ),
      (object) array(
        'label' => 'Schulstart',
        'url'   => '/category/inspiration/schulstart.html'
      ),
      (object) array(
        'label' => 'Taschen nähen',
        'url'   => '/category/inspiration/taschen-naehen.html'
      ),
      (object) array(
        'label' => 'Tiermotivstoffe',
        'url'   => '/category/inspiration/tiermotivstoffe.html'
      ),
      (object) array(
        'label' => 'Trends',
        'url'   => '/category/inspiration/tends.html'
      ),
      (object) array(
        'label' => 'Weihnachten',
        'url'   => '/category/inspiration/weihnachten.html'
      )
    )
  );
  $return->navigation[] = (object) array(
